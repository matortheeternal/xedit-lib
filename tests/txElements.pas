...
begin
  ExpectSuccess(GetElements(_file, '', False, False, False, @len));
  elements := gra(len);
      ...
      Describe('GetElements', procedure
        begin
          ...
          It('Should resolve root children (files)', procedure
            begin
              ExpectSuccess(GetElements(0, '', False, False, False, @len));
              ExpectEqual(len, 9);
          ...
          It('Should resolve file children (file header and groups)', procedure
            begin
              ExpectSuccess(GetElements(skyrim, '', False, False, False, @len));
              ExpectEqual(len, 118);
          ...
          It('Should resolve group children (records)', procedure
            begin
              ExpectSuccess(GetElements(armo1, '', False, False, False, @len));
          ...
          It('Should resolve record children (subrecords/elements)', procedure
            begin
              ExpectSuccess(GetElements(ar1, '', False, False, False, @len));
              ExpectEqual(len, 13);
          ...
          It('Should resolve element children', procedure
            begin
              ExpectSuccess(GetElements(keywords, '', False, False, False, @len));
              ExpectEqual(len, 5);
          ...
          It('Should resolve paths', procedure
            begin
              ExpectSuccess(GetElements(ar2, 'KWDA', False, False, False, @len));
              ExpectEqual(len, 5);
            end);
          ...
          It('Should be able to return sorted elements', procedure
            begin
              ...
              ExpectSuccess(GetElements(0, 'Skyrim.esm', True, False, False, @len));
              TestNames(gra(len), 'File Header', 'Weather');
              ExpectSuccess(GetElements(0, '', True, False, False, @len));
              TestNames(gra(len), 'Skyrim.esm', 'NewFile-1.esp');
          ...
          It('Should not include child groups', procedure
            begin
              ExpectSuccess(GetElements(0, 'Skyrim.esm\DIAL', False, False, False, @len));
